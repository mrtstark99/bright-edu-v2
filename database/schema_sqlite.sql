...
('site_address',      'Số 45 ngõ 207 Quang Trung, Phường Thành Đông, TP Hải Phòng, Việt Nam','text',   'Địa chỉ'),
('legal_entity_name', 'VICTORIA UNIVERSAL CO.,LTD',   'text',    'Tên pháp nhân hoạt động'),
