  ...
  <section class="py-20 bg-white">
    <div class="mx-auto max-w-7xl px-5 lg:px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20 items-stretch">
        ...
        <div class="rounded-3xl bg-primary border border-primary p-8 flex flex-col relative shadow-[0_20px_40px_-15px_rgba(0,0,0,0.3)] z-10 transform md:-translate-y-4">
          ...
          <div class="mb-8 relative">
            <span class="text-4xl font-bold text-white font-display tracking-tight">20.000.000</span>
            <span class="text-white/70 font-medium text-sm ml-1">VNĐ</span>
          </div>
        ...
        <div class="rounded-3xl bg-gradient-to-b from-white to-amber-50/30 border border-slate-100 p-8 flex flex-col relative shadow-sm hover:shadow-medium transition-all duration-300 hover:-translate-y-1">
          ...
          <ul class="space-y-4 mb-8 flex-1">
            <li class="flex items-start gap-3">
              <i class="bi bi-check-circle-fill text-amber-500 mt-1"></i>
              <span class="text-sm text-ink"><em class="text-muted">Bao gồm toàn bộ quyền lợi Gói An Tâm</em></span>
            </li>
            <li class="flex items-start gap-3">
              <i class="bi bi-check-circle-fill text-amber-500 mt-1"></i>
              <span class="text-sm text-ink"><strong class="font-semibold">Đặc quyền ưu tiên:</strong> Kênh hỗ trợ riêng, xử lý 1-1 nhanh mọi vấn đề 24/7.</span>
            </li>
            <li class="flex items-start gap-3">
              <i class="bi bi-check-circle-fill text-amber-500 mt-1"></i>
              <span class="text-sm text-ink"><strong class="font-semibold">Giải quyết tài chính:</strong> Bảo lãnh/Giới thiệu việc làm thêm trong 1-3 tháng đầu.</span>
            </li>
            <li class="flex items-start gap-3">
              <i class="bi bi-check-circle-fill text-amber-500 mt-1"></i>
              <span class="text-sm text-ink"><strong class="font-semibold">Cố vấn tương lai:</strong> Định hướng thi lên Đại học/Senmon hoặc chuyển visa đi làm.</span>
            </li>
            <li class="flex items-start gap-3">
              <i class="bi bi-check-circle-fill text-amber-500 mt-1"></i>
              <span class="text-sm text-ink"><strong class="font-semibold">Hỗ trợ khẩn cấp:</strong> Hỗ trợ trực tiếp sự cố (ốm đau, pháp lý). Báo cáo tình hình định kỳ.</span>
            </li>
            <li class="flex items-start gap-3">
              <i class="bi bi-check-circle-fill text-amber-500 mt-1"></i>
              <span class="text-sm text-ink"><strong class="font-semibold text-amber-600">Bảo vệ trọn khóa:</strong> Đồng hành 24 tháng.</span>
            </li>
          </ul>
          <a href="/contact?package=vip" class="w-full block text-center rounded-2xl bg-amber-500 text-white px-6 py-3.5 font-bold hover:bg-amber-600 transition-colors shadow-[0_10px_20px_-10px_rgba(245,158,11,0.5)]">Đăng ký gói VIP</a>
        </div>
      </div>
      ...
      <div class="mt-24">
        ...
        <div class="overflow-x-auto rounded-2xl border border-slate-200 shadow-sm hide-scrollbar">
