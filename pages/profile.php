...
<div class="pt-[140px] pb-24 bg-slate-50 min-h-screen">
    <div class="mx-auto max-w-5xl px-5 lg:px-8">
        <div class="flex items-center justify-between mb-8">
            <h1 class="text-3xl font-bold text-midnight font-display">Hồ sơ cá nhân</h1>
        </div>
        ...
        <div class="grid lg:grid-cols-3 gap-8">
            <div class="lg:col-span-1">
                <div class="bg-white rounded-3xl shadow-soft border border-slate-100 overflow-hidden text-center p-8 sticky top-32">
                    ...
                    <div class="border-t border-slate-100 pt-6">
                        ...
                        <p class="text-sm text-slate-500 text-left mb-2">
                            <span class="font-bold text-slate-700">Ngày tham gia:</span> <?php echo date('d/m/Y', strtotime($user['created_at'])); ?>
                        </p>
