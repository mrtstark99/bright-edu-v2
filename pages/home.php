...
?>
  ...
  <main id="hero">
    <section class="relative pt-[140px] pb-0 w-full min-h-[60vh] lg:min-h-[75vh] flex items-end" style="background-image: url('/assets/images/sakura_bg.png'); background-size: cover; background-position: center; background-repeat: no-repeat;">
...
<div class="relative mx-auto max-w-7xl px-5 lg:px-8 w-full z-10">
    ...
    <!-- Hành trình du học (Moved from du-hoc.php) -->
    <section class="py-20 lg:py-28 bg-white relative">
      <div class="mx-auto max-w-7xl px-5 lg:px-8">
        <div class="mx-auto mb-12 max-w-2xl text-center">
          <span class="text-primary font-bold tracking-wider uppercase text-xs mb-3 block">Hành trình du học</span>
          <h2 class="text-3xl sm:text-4xl font-bold text-primary font-display">Các Bước Khởi Đầu</h2>
        </div>
